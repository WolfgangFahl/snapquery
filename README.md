...
| **Code** | [![style-black](https://img.shields.io/badge/%20style-black-000000.svg)](https://github.com/psf/black) [![imports-isort](https://img.shields.io/badge/%20imports-isort-%231674b1)](https://pycqa.github.io/isort/) [![Join the discussion at https://github.com/WolfgangFahl/snapquery/discussions](https://img.shields.io/github/discussions/WolfgangFahl/snapquery)](https://github.com/WolfgangFahl/snapquery/discussions) |
...
| **Cite** | [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17802424.svg)](https://doi.org/10.5281/zenodo.17802424) |

## Cite as

If you use snapquery in your research, please cite it via its Zenodo concept DOI
(which always resolves to the latest version):

> Fahl, W., Holzheim, T., Hoyt, C. T., Priskorn, D., & Willighagen, E.
> *SnapQuery — FAIR Management of Query Sets to Mitigate Query Rot in Knowledge Graphs.*
> Zenodo. https://doi.org/10.5281/zenodo.17802424
...
[Zenodo record](https://doi.org/10.5281/zenodo.17802424).
